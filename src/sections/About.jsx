...
const About = () => {
  return (
    <section className="flex  justify-around items-center max-sm:flex-col max-lg:flex-col max-xl:flex-col h-fit px-10 max-sm:pt-16 pt-[160px] pb-20 " >
      <div>
        <img src={gojo} className="rounded-full h-[300px] max-sm:h-[140px] " />
      </div>

      <div className="w-[80vh] max-sm:w-[50vh]">
        <h2 className="text-3xl font-montserrat max-sm:text-center text-[#bbbbbb] py-[40px]">About Me</h2>
        <p className="text-2xl max-sm:text-[16px] font-nunito text-[#71717a] px-[10px] text-center text-wrap ">
