...
const Skills = () => {
  return (
    <section className="flex justify-start flex-col mx-2 h-fit pb-[130px] ">
      ...
      {tech.map((icon)=>(
          <div className="bg-[#0a0a0a] backdrop-blur-xl rounded-full p-[18px] max-sm:p-[15px] border-[3px] border-[#27272a]  hover:border-slate-300 flex justify-center items-center shadow-xl">
